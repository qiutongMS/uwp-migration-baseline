...
![after_Button: Volume](screenshots/01_MainPage__01_Button_Volume.png)

After click **Button: Like**:

![after_Button: Like](screenshots/01_MainPage__02_Button_Like.png)

After click **Button: Show playback rate list**:

![after_Button: Show playback rate list](screenshots/01_MainPage__03_Button_Show_playback_rate_list.png)

After click **Button: Aspect Ratio**:

![after_Button: Aspect Ratio](screenshots/01_MainPage__04_Button_Aspect_Ratio.png)

After click **Button: Cast to Device**:

![after_Button: Cast to Device](screenshots/01_MainPage__05_Button_Cast_to_Device.png)
